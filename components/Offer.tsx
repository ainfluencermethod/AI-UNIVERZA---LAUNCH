...
export const Offer: React.FC = () => {
  return (
    <section id="offer" className="bg-black relative overflow-hidden">
       ...
       <div className="bg-black py-12 md:py-20 px-4 border-b border-white/5">
           <div className="max-w-5xl mx-auto text-center flex flex-col items-center">
                <h2 className="text-2xl md:text-5xl font-black text-white leading-[1.1] tracking-tighter uppercase mb-6 max-w-4xl mx-auto drop-shadow-2xl">
                ...
                <p className="text-base md:text-xl text-gray-400 font-bold max-w-2xl mx-auto leading-relaxed">
                ...
                <div className="mt-8 h-1 w-16 bg-brand-gold rounded-full opacity-50 animate-pulse"></div>
           </div>
       </div>

       {/* Main Offer Content */}
       <div className="py-24 px-4 bg-gradient-to-br from-[#AA771C] via-[#FCF6BA] to-[#B38728] relative">
