  ...
  return (
    <div className="relative pt-24 pb-16 md:pt-36 md:pb-32 px-4 text-center overflow-hidden bg-black flex flex-col items-center">
      ...
      <div className="relative w-full z-10 flex flex-col items-center max-w-[90rem]">
        ...
        {/* 1. Headline */}
        <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-serif font-black text-white leading-[1.1] mb-6 tracking-tight drop-shadow-2xl max-w-5xl mx-auto animate-fade-in-up text-center px-2" style={{ animationDelay: '100ms' }}>
          30 Dni, da <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFD700] via-[#FDB931] to-[#FFD700] italic">Kopiraš Moj AI Sistem</span> in Začneš <span className="text-white underline decoration-brand-gold/50 underline-offset-8">Ustvarjati Dohodek</span> v 2026
        </h1>
